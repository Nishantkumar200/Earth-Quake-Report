...
// This is hard code passed data
    ...
    // Constructor is private because no one can make another constructor of the same name;
    private QueryUtils() {

    }

    public static ArrayList<QuakeInformation> extractQuakeInformation() {


        // Creating an empty arraylist to add new earth quake
        ArrayList<QuakeInformation> quakeInformations = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Log.e("earthqake", String.valueOf(currentearthquake));
                ...
                QuakeInformation quakeInformation = new QuakeInformation(time, magnitude, place,url);
                quakeInformations.add(quakeInformation);
